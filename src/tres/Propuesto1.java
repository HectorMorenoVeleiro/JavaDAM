...
public class Propuesto1 {
    ...
    public static void main(String[] args) {
        int A = AjustesProgramas.introduceNumeroPorScanner("DIME UN NUMERO ENTERO A -> ");
        int B = AjustesProgramas.introduceNumeroPorScanner("DIME UN NUMERO ENTERO B -> ");
        int C = AjustesProgramas.introduceNumeroPorScanner("DIME UN NUMERO ENTERO C -> ");
